...
func NewManager() *Manager {
	...
	m.structured = map[string]func(context.Context, map[string]interface{}) ToolResult{
		...
		ToolBrowserReload:           m.browserReloadStructured,
		ToolBrowserViewport:         m.browserViewportStructured,
		ToolBrowserVisibility:       m.browserVisibilityStructured,
		ToolBrowserClipboard:        m.browserClipboardStructured,
		ToolBrowserCUA:              m.browserCUAStructured,
		ToolBrowserDOMCUA:           m.browserDOMCUAStructured,
		ToolBrowserLocator:          m.browserLocatorStructured,
		ToolBrowserDevLogs:          m.browserDevLogsStructured,
		ToolBrowserDownloads:        m.browserDownloadsStructured,
		ToolBrowserUserTabs:         m.browserUserTabsStructured,
		ToolBrowserSessionName:      m.browserSessionNameStructured,
